...
## [3.0.0](https://github.com/rubycidev/postal/compare/v3.3.4...3.0.0) (2024-08-06)


### Features

* add "postal:update" task ([b35eea6](https://github.com/rubycidev/postal/commit/b35eea6338f1888bfac2ed377d0a412680483e90))
* add health server and prometheus metrics to worker ([a2eb70e](https://github.com/rubycidev/postal/commit/a2eb70edf1507ad7e235f3a817c44e1a028e42a8))
* add helm env var config exporter ([8938988](https://github.com/rubycidev/postal/commit/893898835dcd9684ae3401549389b173a3feb1fb))
* add option to delay starting processes until all migrations are run ([1c5ff5a](https://github.com/rubycidev/postal/commit/1c5ff5a9a615f73ba4731549c1e328b21b753290))
* add prometheus metrics to smtp server ([2e7b36c](https://github.com/rubycidev/postal/commit/2e7b36c1be257fd2379a2e9d68d7f8af9d003302))
* add prometheus metrics to worker ([bea7450](https://github.com/rubycidev/postal/commit/bea7450d8f067539521c00c7c339b0837a83e42b))
* add sha256 signatures to outgoing http requests ([#2874](https://github.com/rubycidev/postal/issues/2874)) ([96d7365](https://github.com/rubycidev/postal/commit/96d73653d7cb4dde1fbe74ccb3596147ef8cd9ed))
* automatically remove queued messages with stale locks ([#2872](https://github.com/rubycidev/postal/issues/2872)) ([d84152e](https://github.com/rubycidev/postal/commit/d84152eb5df6f963426d6ba8d02d39b3c146c8a5))
* configurable trusted proxies for web requests ([3785c99](https://github.com/rubycidev/postal/commit/3785c998513c634d225b489ccb43e926ce3f270a))
* include list-unsubscribe-post header in dkim signatures ([e1bae60](https://github.com/rubycidev/postal/commit/e1bae60768c4cf151d5a6a141985c78753dce02d)), closes [#2789](https://github.com/rubycidev/postal/issues/2789) [#2788](https://github.com/rubycidev/postal/issues/2788)
...
* more consistent logging ([044058d](https://github.com/rubycidev/postal/commit/044058d0f159f444c4c1d8d7765307bb64529ca4))
* new background work process ([dc8e895](https://github.com/rubycidev/postal/commit/dc8e895bfedd08e97f4da40783df4ce1d30d9108))
* new configuration system (and schema) ([#2819](https://github.com/rubycidev/postal/issues/2819)) ([0163ac3](https://github.com/rubycidev/postal/commit/0163ac3d10f956980e9611b87585f1d05367385f))
* only accept RFC-compliant End-of-DATA sequence ([0140dc4](https://github.com/rubycidev/postal/commit/0140dc44839e77ab8fdf55a0f02b19096b241f98))
* openid connect support ([#2873](https://github.com/rubycidev/postal/issues/2873)) ([5ed94f6](https://github.com/rubycidev/postal/commit/5ed94f6f855735aa00544b2574dfb9e65d559a38))
* privacy mode ([15f9671](https://github.com/rubycidev/postal/commit/15f9671b667cf369255aaa27ee4257267990095c))
* **prometheus:** add `postal_message_queue_latency` metric ([ee8d829](https://github.com/rubycidev/postal/commit/ee8d829a854f91e476167869cafe35c2d37bb314))
...
* support for additional SMTP client options ([0daa667](https://github.com/rubycidev/postal/commit/0daa667b55fd9b948da643d37ec438e341809369))
...
* **worker:** allow number of threads to be configured ([7e2accc](https://github.com/rubycidev/postal/commit/7e2acccd1ebd80750a3ebdb96cb5c36b5263cc24))
* **worker:** scale connection pool with worker threads ([ea542a0](https://github.com/rubycidev/postal/commit/ea542a0694b3465b04fd3ebc439837df414deb1e))
...
* default to listening on all addresses when using legacy config ([48f6494](https://github.com/rubycidev/postal/commit/48f6494240eb0374d5f865425b362e6f306b2653))
* don't override paths in dockerfile ([9399e32](https://github.com/rubycidev/postal/commit/9399e3223467cdacd010e70b58ad6093e128213d))
* don't use authentication on org & server deletion ([be45652](https://github.com/rubycidev/postal/commit/be456523dd3aacb5c3eb45c9261da97ebffe603c))
...
* ensure encoding is set for message db ([ae30cc7](https://github.com/rubycidev/postal/commit/ae30cc7615acb0a2f57b5635b9704f2f0259d22a))
...
* fix `postal version` command ([4fa88ac](https://github.com/rubycidev/postal/commit/4fa88acea0dececd0eae485506a2ad8268fbea59))
* fix bug in smtp server when exceptions occur ([9dd00f6](https://github.com/rubycidev/postal/commit/9dd00f6edd9f80252f9f51db48d712993fc9011b))
...
* fix issue running message pruning task ([3a33e53](https://github.com/rubycidev/postal/commit/3a33e53d843584757bb00898746aa059d7616db4))
* fix issue with sending mail when smtp relays are configured ([6dd6e29](https://github.com/rubycidev/postal/commit/6dd6e29929c70eaa8b9d3b33c184996b0b6abb82))
* fix smtp TLS ([defb511](https://github.com/rubycidev/postal/commit/defb5114d0a5d3c0a2fcd4c10d89acf6967d55b0))
* fixed typo (rfc number) ([2f62baa](https://github.com/rubycidev/postal/commit/2f62baa238fc1102706ee4acf079b7a876b05283))
* fixes `postal default-dkim-record` ([58dddeb](https://github.com/rubycidev/postal/commit/58dddebeb81dc6fab945d2b10a91588eddc471c2))
...
* fixes issue with SMTP sender with address endpoints ([2621a19](https://github.com/rubycidev/postal/commit/2621a190b1f9114c245f5257735484cfef2b8003))
* fixes potential issue if machine hostname cannot be determined ([0fcf778](https://github.com/rubycidev/postal/commit/0fcf778a5189e0fc38727f3e64f036e8619c6b3a))
...
* **legacy-api:** allow _expansions to be provided as true to return all expansions ([39f704c](https://github.com/rubycidev/postal/commit/39f704c256fc3e71a1dc009acc77796a1efffead)), closes [#2932](https://github.com/rubycidev/postal/issues/2932)
...
* **message-dequeuer:** ability to disable batching ([4fcb9e9](https://github.com/rubycidev/postal/commit/4fcb9e9a2e34be5aa4bdf13f0529f40e564b72b4))
* **message-dequeuer:** ensure SMTP endpoints are sent to SMTP sender appropriately ([e2d642c](https://github.com/rubycidev/postal/commit/e2d642c0cbf443550886d90abc3a6edf3e4bc4fc)), closes [#2853](https://github.com/rubycidev/postal/issues/2853)
...
* raise an error if MX lookup times out during sending ([fadca88](https://github.com/rubycidev/postal/commit/fadca88f456c11a761a21fd0bba941a3e4c5e3c6)), closes [#2833](https://github.com/rubycidev/postal/issues/2833)
* raise NotImplementedError when no call method on a scheduled task ([2b0919c](https://github.com/rubycidev/postal/commit/2b0919c1454eabea93db96f50ecbd8e36bb89f1f))
...
* remove support for setting the 'ssl' option for app-level smtp use ([658aa71](https://github.com/rubycidev/postal/commit/658aa7148333923696c0ad998a922965cf5cacab))
* remove user email verification ([e05f0b3](https://github.com/rubycidev/postal/commit/e05f0b3616da8b962b763c48a2139882fd88047a))
...
* set correct component in health server log lines ([a7a9a18](https://github.com/rubycidev/postal/commit/a7a9a18b201ec1b70de7bf0995a3f934de57405a))
* **smtp-sender:** ensure relays without a host are excluded ([3a56ec8](https://github.com/rubycidev/postal/commit/3a56ec8a74950e0162d98f1af5f58a67a82d6455))
* **smtp-sender:** fixes `SMTPSender.smtp_relays` ([b3264b9](https://github.com/rubycidev/postal/commit/b3264b942776e254d3c351c94c435d172a514e18))
* **smtp-server:** add additional information to cram-md5 log entries ([9982bb8](https://github.com/rubycidev/postal/commit/9982bb8c31ee4885d188666e2e8afdc218528df7))
* **smtp-server:** fixes proxy protocol ([9240612](https://github.com/rubycidev/postal/commit/92406129cfcf1a06499a6f5aa18c73f1d6195793))
* **smtp-server:** listen on all interfaces by default ([d1e5b68](https://github.com/rubycidev/postal/commit/d1e5b68200ea4b9710cc8714afb3271bad1f4f66)), closes [#2852](https://github.com/rubycidev/postal/issues/2852)
* **smtp-server:** remove ::ffff: from the start of ipv4 addresses ([0dc7359](https://github.com/rubycidev/postal/commit/0dc7359431001c9ef1222913f8d1344093397596))
* **smtp-server:** reset ansi sequence after logging ([9bf6152](https://github.com/rubycidev/postal/commit/9bf6152060ffb8b611b66818c1d1ac7c929b7ffe))
* translate unicode domain names to Punycode for compatibility with DNS ([#2823](https://github.com/rubycidev/postal/issues/2823)) ([be0df7b](https://github.com/rubycidev/postal/commit/be0df7b46304515a18ebec09f968b1a3ba2e1e0a))
* truncate output and details in deliveries to 250 characters ([694240d](https://github.com/rubycidev/postal/commit/694240ddcdef1df9b32888de8fb743d2dee86462)), closes [#2831](https://github.com/rubycidev/postal/issues/2831)
* **ui:** fixes typo on queue page ([33513a7](https://github.com/rubycidev/postal/commit/33513a77c0df24d832ab7ed5237d68e2b1bde887))
* unescape in URLs which are stored for tracking ([1da1182](https://github.com/rubycidev/postal/commit/1da1182c23e9673d8f109d8ed29e80983cdccabf)), closes [#2568](https://github.com/rubycidev/postal/issues/2568) [#907](https://github.com/rubycidev/postal/issues/907) [#115](https://github.com/rubycidev/postal/issues/115)
...
* update wording about tracking domain cnames ([0d3eccb](https://github.com/rubycidev/postal/commit/0d3eccb368630b4fd21bd858a7829ec00c35f153)), closes [#2808](https://github.com/rubycidev/postal/issues/2808)
...
* use local resolver for DNS tests (github actions blocks DNS seemingly) ([a4d039c](https://github.com/rubycidev/postal/commit/a4d039c44de0772ddad0351c6c155fcc437c1bf4))
...
* **web-server:** allow for trusted proxies not be set ([4e1deb2](https://github.com/rubycidev/postal/commit/4e1deb2d2aeb61d9dddb3729916411c94e73c1c6))


### Documentation

* add message_db.encoding to config docs ([0c1f925](https://github.com/rubycidev/postal/commit/0c1f9250d40f030e4e0aa456617222142b4797b8))
* add new repo readme welcome image ([afa1726](https://github.com/rubycidev/postal/commit/afa1726d0d63526c5b3ede394efa72a4b4629abd))
* add quick contributing instructions ([8d21adc](https://github.com/rubycidev/postal/commit/8d21adcbd45c279dd21137cabbf6f98f2698b090))
* update docs for how IP address allocation works ([07eb152](https://github.com/rubycidev/postal/commit/07eb15246f524f495b473cf97ddd51f661f8b5bf)), closes [#2209](https://github.com/rubycidev/postal/issues/2209)
* update readme ([df096ab](https://github.com/rubycidev/postal/commit/df096abdc74cd12273c5d4d2c52f6792844c0588))
* update SECURITY policy ([cfc1c9b](https://github.com/rubycidev/postal/commit/cfc1c9b73e5b0914aec6d56a62e60561697ec660))
...
* **rubocop:** Style/TrailingCommaInArrayLiteral ([4e13577](https://github.com/rubycidev/postal/commit/4e13577891dc827244abc6bf6d9ab4ee45860556))
...
* **rubocop:** use _ when not using a variable in helm config exporter ([2c20ba6](https://github.com/rubycidev/postal/commit/2c20ba65f64ccb0f8174e3f523dedb3806478782))


### Miscellaneous Chores

* add annotations to factories and models specs ([ed6da11](https://github.com/rubycidev/postal/commit/ed6da11b65811e39c2641bb3c9bc2474ca006c0a))
* add arm64 platform ([de88201](https://github.com/rubycidev/postal/commit/de88201f61fb263be67f2be9cf0aaa1868f3c66b))
...
* add script for generating smtp TLS certificates ([6eb16c3](https://github.com/rubycidev/postal/commit/6eb16c3fab0ede68b0784066c5573bd2db1f67dd))
...
* allow config location message to be suppressed ([f760cdb](https://github.com/rubycidev/postal/commit/f760cdb5a1d53e9c30ee495d129cbf12603a3cbd))
...
* **config-docs:** update docs for latest oidc defaults ([364eba6](https://github.com/rubycidev/postal/commit/364eba6c5fce2f08a36489f42856ad5024a2062c))
* **config-docs:** update proxy protocol to mention v1 ([45dd8aa](https://github.com/rubycidev/postal/commit/45dd8aaac56f15481cb7bf9081401cb28dc1e707))
* consolidate platforms in Gemfile ([7963c8a](https://github.com/rubycidev/postal/commit/7963c8af1606a1e14683a59bd759e888edf23dbd))
* **container:** add the branch name to the container ([bee5098](https://github.com/rubycidev/postal/commit/bee509832edc151d97fe5bfc48c4973452873fc8))
* **gha:** upgrade github checkout action, don't create arm images for CI, add qemu ([a9ade3c](https://github.com/rubycidev/postal/commit/a9ade3c8bc5974ef448289b6eb80c27ebd9588b7))
...
* **github-actions:** don't generate commit- tags ([d65bbe0](https://github.com/rubycidev/postal/commit/d65bbe0579037c5df962a18134bc007f5159d7e5))
* **github-actions:** don't run for dependabot or release-please PRs and fetch whole repo ([adaf2b0](https://github.com/rubycidev/postal/commit/adaf2b07502e9ed91290873ad8465051c6fd814f))
* **github-actions:** include a version string on branch-*/latest images ([64bc7dc](https://github.com/rubycidev/postal/commit/64bc7dcf7c0a8e006ab6eb6e8b4a52ad5e7e6528))
* hide further config messages ([1c67f72](https://github.com/rubycidev/postal/commit/1c67f72209c93404d7024ce3d15f6f54f2d707c4))
...
* **main:** release 2.3.2 ([343292b](https://github.com/rubycidev/postal/commit/343292bbdecfaf5edfa7322bd78fed248afdad65))
* **main:** release 3.0.0 ([7030fd5](https://github.com/rubycidev/postal/commit/7030fd5512a7b227b27b694985878ada0cae9b8c))
* **main:** release 3.0.1 ([7fd538d](https://github.com/rubycidev/postal/commit/7fd538d6c4a517c159f1a7bac47f5480839dc88b))
* **main:** release 3.0.2 ([93cbe31](https://github.com/rubycidev/postal/commit/93cbe310823aca4f4f065f5f60c4547bdde9fd16))
* **main:** release 3.1.0 ([4acfffd](https://github.com/rubycidev/postal/commit/4acfffd1d88e5a7beca87a0c084326392dc3e6eb))
* **main:** release 3.1.1 ([#2859](https://github.com/rubycidev/postal/issues/2859)) ([4c27bae](https://github.com/rubycidev/postal/commit/4c27baee7ff554097c4a982c289dbbd4edc9db7a))
* **main:** release 3.2.0 ([#2867](https://github.com/rubycidev/postal/issues/2867)) ([8e71dd0](https://github.com/rubycidev/postal/commit/8e71dd0232fbd12cbe9762877192cf0d0e37f359))
* **main:** release 3.2.1 ([#2877](https://github.com/rubycidev/postal/issues/2877)) ([144af20](https://github.com/rubycidev/postal/commit/144af20b9c3b66f42d78a2d3e3b2bbdcb11a315a))
* **main:** release 3.2.2 ([#2878](https://github.com/rubycidev/postal/issues/2878)) ([6a1ff56](https://github.com/rubycidev/postal/commit/6a1ff56fe269e5ace18de9fe88094a5afc87eaac))
* **main:** release 3.3.0 ([#2887](https://github.com/rubycidev/postal/issues/2887)) ([eded789](https://github.com/rubycidev/postal/commit/eded789c37fd0a82056e6c1919fd808ae82154f2))
* **main:** release 3.3.1 ([#2890](https://github.com/rubycidev/postal/issues/2890)) ([a3fab36](https://github.com/rubycidev/postal/commit/a3fab36da2e005fff46c0966c9b9fe7db5ee15ff))
* **main:** release 3.3.2 ([#2892](https://github.com/rubycidev/postal/issues/2892)) ([c12f30e](https://github.com/rubycidev/postal/commit/c12f30e300bba70e36eb196aa63af0f02d48a0af))
* **main:** release 3.3.3 ([#2933](https://github.com/rubycidev/postal/issues/2933)) ([d510499](https://github.com/rubycidev/postal/commit/d5104991903d42563c6c6f7ff01276d496e3304f))
* **main:** release 3.3.4 ([#3014](https://github.com/rubycidev/postal/issues/3014)) ([da90e75](https://github.com/rubycidev/postal/commit/da90e75036c27482699921613d838f4058a100e7))
* reduce threads for bundling in docker ([5b022b9](https://github.com/rubycidev/postal/commit/5b022b9394623b47a9fe85654ef54131516314ae))
* regenerate config docs ([5d8213a](https://github.com/rubycidev/postal/commit/5d8213a98735f07fdf1700c7d01597654f41dbd0))
* release 3.0.0 ([47b203c](https://github.com/rubycidev/postal/commit/47b203c3729ada6faf59925174ca14d2ea510d4e))
* remove -j4 from bundle install as it shouldn't be needed ([0b468f9](https://github.com/rubycidev/postal/commit/0b468f97c5cfc73f123448dacd13738cd795989c))
* remove non-breaking spaces from comments ([27b7ced](https://github.com/rubycidev/postal/commit/27b7ced3bc022d6a6054e8a6c8847e7533378428))
...
* removing arm64 support until we can get a reasonable build pipeline sorted ([e8e44f5](https://github.com/rubycidev/postal/commit/e8e44f54b09426c8a04e466bc037851a0833d124))
...
* suppress config location on default-dkim-record ([aa76aae](https://github.com/rubycidev/postal/commit/aa76aae2322af41af1bd60cfe1d69a11ac76324e))
* **ui:** display branch in footer if present ([1823617](https://github.com/rubycidev/postal/commit/18236171ebc398c157f2e61b15c7df9f91205284))
* update CHANGELOG about v3 ([fd33e21](https://github.com/rubycidev/postal/commit/fd33e2166799ad83704989b3d4e15ace850c6795))
* update MIT-LICENCE ([dbd0e27](https://github.com/rubycidev/postal/commit/dbd0e279f5c6682f81eab09047719698715694ac))
...
* upgrade bundler to 2.5.6 ([1ae8ef6](https://github.com/rubycidev/postal/commit/1ae8ef6401718464ce19c1a2d22acd5261280168))
...
* upgrade rails to 7.0 and other dependencies ([ecd09a2](https://github.com/rubycidev/postal/commit/ecd09a2445f82f4897265caf4a3bf6b6cd2146cb))
* upgrade ruby to 3.2.2 and nodejs to 20.x ([72715fe](https://github.com/rubycidev/postal/commit/72715fe5f8d8977a0fb058973ba31d781cb7cfe1))


### Code Refactoring

* be less verbose with message DB migrations ([90d3a3f](https://github.com/rubycidev/postal/commit/90d3a3f8c969ad5e7263e737117c5771cc783701))
* change domain used for dns resolver testing ([87d35d7](https://github.com/rubycidev/postal/commit/87d35d7c411e1bdae7654089fd8801b6fee1ab4c))
* move app/util/* to app/lib/ ([eb246bb](https://github.com/rubycidev/postal/commit/eb246bb4e70b42879846c52f84e482d7ffd52084))
* move lib/postal/received_header to app/lib/received_header ([e3bc9da](https://github.com/rubycidev/postal/commit/e3bc9da253bf278b05e675148220fea5a27eb988))
* move lib/postal/reply_separator to app/lib/reply_separator ([5cc9eb3](https://github.com/rubycidev/postal/commit/5cc9eb3df79e79fee77f1479a85a4886ab6295d7))
* move lib/postal/smtp_server to app/lib/smtp_server ([321ab95](https://github.com/rubycidev/postal/commit/321ab95936ec626b7574bbc78072309c02a8f0ad))
* move lib/postal/user_creator to app/util/user_creator ([64b2704](https://github.com/rubycidev/postal/commit/64b2704b02991c5eed808360503c78222d610b89))
* move Postal::BounceMessage to app/models/bounce_message ([05d2ec4](https://github.com/rubycidev/postal/commit/05d2ec4d042c350a2c8580b1c3ee308ccaf34293))
* move Postal::DKIMHeader to app/util/dkim_header ([77faf88](https://github.com/rubycidev/postal/commit/77faf886b39ca0c3fc8d923bd129c26a0d9f19c3))
* move Postal::QueryString to app/util/query_string ([870b26c](https://github.com/rubycidev/postal/commit/870b26c2f2f80a04fe905a7cc8e859c8eee50e70))
* move senders in to app/senders/ ([73a55a5](https://github.com/rubycidev/postal/commit/73a55a5053b871cd0ca923aace208617342c5f55))
* move tracking middleware ([b8ad732](https://github.com/rubycidev/postal/commit/b8ad732152ca2cbca6d4aacdb1fc365fe944fad4))
* move worker from lib/worker to app/lib/worker ([93fc120](https://github.com/rubycidev/postal/commit/93fc120f442f1bce46040a708a041e8ba7885b42))
* refactor DNS resolution ([1a41586](https://github.com/rubycidev/postal/commit/1a4158699c452966308af02d7f2a26dd094be208))
* refactor log use within SMTP server ([cae4b63](https://github.com/rubycidev/postal/commit/cae4b63599c18e25ff8ad464b7cb6246bc155380)), closes [#2794](https://github.com/rubycidev/postal/issues/2794) [#2791](https://github.com/rubycidev/postal/issues/2791)
* refactor the SMTP sender ([633c509](https://github.com/rubycidev/postal/commit/633c509a4509dcba9324e46a8a9cabe48784ec0a))
* refactor webhook deliveries ([e0403ba](https://github.com/rubycidev/postal/commit/e0403ba641b978e67766ab9283e0904a00d2977b))
* refactors message dequeueing ([#2810](https://github.com/rubycidev/postal/issues/2810)) ([a44e1f9](https://github.com/rubycidev/postal/commit/a44e1f9081b51ae516278b08d93d0c8c67071c1f))
* remove explicit autoload ([0f9882f](https://github.com/rubycidev/postal/commit/0f9882f13204124df630606b1b9e36787c9c4011))
* remove moonrope but maintain legacy API actions ([#2889](https://github.com/rubycidev/postal/issues/2889)) ([4d9654d](https://github.com/rubycidev/postal/commit/4d9654dac47d59c760be96388d0421de74d3e6ac))
...
* remove token logins ([b89e0a9](https://github.com/rubycidev/postal/commit/b89e0a9e8210b62f8aeecd2904dea14f1678d31c))
* remove unnecessary modules ([38465de](https://github.com/rubycidev/postal/commit/38465de120492a61372df44fc629286618224b7c))
* remove unused UserController#join method ([1ca18db](https://github.com/rubycidev/postal/commit/1ca18dbc6e4044c59676294b67ca737025923874))
* switch to use SecureRandom for random strings ([ce30c07](https://github.com/rubycidev/postal/commit/ce30c070bd5f095392fb9a68ebb690f97fe5ebaf))
* **versioning:** improve how current version and branch is determined and set ([07c6b31](https://github.com/rubycidev/postal/commit/07c6b317f2b9dc04b6a8c88df1e6aa9e54597504))
...
* add smtp sender test for MX lookup timeouts ([e4638a0](https://github.com/rubycidev/postal/commit/e4638a0c40e965369f2b3a5ba158fe6abd9a47f1))
* add test for multiline headers ([77e818a](https://github.com/rubycidev/postal/commit/77e818a472571d043ab0d8bc27650d98ad3ea97b))
* add tests for DNSResolver ([8765d8e](https://github.com/rubycidev/postal/commit/8765d8e57a9dce62dc09b46b21c12dd424867925))
* add tests for message unqueueing ([b4016f6](https://github.com/rubycidev/postal/commit/b4016f6b49900a09b5d10d1d84fcc5cc2518d9ca))
* add tests for Server model ([2023200](https://github.com/rubycidev/postal/commit/2023200d91964882382fe42ca44f340797023ef8))
* add tests for the legacy API ([3d208d6](https://github.com/rubycidev/postal/commit/3d208d632f4fc8a4adbfdb2bf4b377271eae6692))
* additional tests for batched messages when unqueueing messages ([8b61100](https://github.com/rubycidev/postal/commit/8b611000821520313b7deaf1f119abd4cda10625))
...
* fix test that was failing due to time differences ([465f4d8](https://github.com/rubycidev/postal/commit/465f4d82476416296e6bd4cdfaaa0f34305edfc9))
* move Postal::RpecHelpers to spec/helpers ([ee86311](https://github.com/rubycidev/postal/commit/ee8631152534ca52fe4aba5009691bc1a3830b91))
* move TestLogger to spec/helpers ([3bbbc70](https://github.com/rubycidev/postal/commit/3bbbc70bc1ed27232b570af4bdd73d0ba188cd6f))
...
* **smtp-sender:** add more tests for AUTH LOGIN ([22dcd49](https://github.com/rubycidev/postal/commit/22dcd4901f188915cf4b3c758c6f2fc637a4e1e3))
